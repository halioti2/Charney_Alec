...
const mockRecord = {
  ...
  auditTrail: [
    { id: 'EV1', category: 'Approval', actor_name: 'Coordinator', created_at: '2024-09-08T10:00:00Z', action: 'Approved by Coordinator.' },
    { id: 'EV2', category: 'Approval', actor_name: 'Broker', created_at: '2024-09-08T12:00:00Z', action: 'Final approval by Broker.' },
  ],
};
...
describe('CommissionModal', () => {
  ...
  it('closes when Escape is pressed', () => {
    ...
    render(
      <ToastProvider>
        <DashboardProvider initialState={{}}>
          <CommissionModal isOpen onClose={onClose} commissionRecord={mockRecord} onAction={vi.fn()} />
        </DashboardProvider>
      </ToastProvider>,
    );
