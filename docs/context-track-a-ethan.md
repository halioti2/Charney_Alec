...
## Build Checklist
### Phase 1A – Auto-Approval (See Backend Implementation Phase 1A & PDF Journey Path A)
...
### Phase 1B – Manual Verification (See Backend Implementation Phase 1B & PDF Journey Path B)
5. Implement Supabase edge functions or serverless endpoints as needed (e.g., signed URLs, checklist status updates, verification submit).  
